...
export default {
    ...
    methods: {
        ...
        search(event) {
            ...
            this.dstk = dscurrent.filter((e) => this.dsnv.filter((i) => i._id == e.ma_nhan_vien_xuat_don)[0].ho_ten.toLowerCase().includes(event.target.value.toLowerCase()))
        },
        toDate(date) {
    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-6 text-end">
                <input @input="search($event)" type="text" class="search" placeholder="Tìm kiếm theo tên nhân viên"
            ...
            <table class="table table-hover text-center mt-3">
                ...
                <tbody>
                    <tr v-for="(e, i) in this.dstk" :key="i">
                        ...
                        <!-- <td>{{ this.dsnv.filter((i) => i._id == e.ma_nhan_vien_xuat_don)[0].ho_ten }}</td> -->
